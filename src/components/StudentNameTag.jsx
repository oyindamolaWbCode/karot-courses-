...
const StudentNameTag = () => {
  return (
    <div className="flex justify-between bg-white shadow-md py-[2vw] px-[2.5vw] items-center font-inter">

        <div className="flex gap-[1.5vw] items-center">
            <img src={profile} alt="" />
            <div>
                <p className="text-[#7B7B7B] ">Student’s profile</p>
                <h3 className="text-[#313948] font-[700] text-[1.5vw]">Musa Chidiebere</h3>
            </div>
        </div>
